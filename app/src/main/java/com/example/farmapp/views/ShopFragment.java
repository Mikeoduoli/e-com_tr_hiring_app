...
import com.example.farmapp.adapters.ShopListAdapter;
import com.example.farmapp.databinding.FragmentShopBinding;
...
public class ShopFragment extends Fragment implements ShopListAdapter.ShopInterface {
    ...
    public void addItem(Product product) {
        ...
        if (isAdded){
            ...
            Snackbar.make(requireView(), "No more Item Can be Added To Cart.", Snackbar.LENGTH_LONG)
                    .show();
        }
